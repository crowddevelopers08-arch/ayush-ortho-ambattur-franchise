                ...
                <div className="flex-1 text-center lg:text-left w-full">
                  ...
                  <div className="space-y-2 sm:space-y-3 md:space-y-4 mb-3 sm:mb-4 md:mb-0 w-full">
                    <div className="flex items-start justify-center lg:justify-start">
                      ...
                      <p className="text-xs sm:text-sm md:text-base">2ND Floor, 122/124/1, Vijayalakshmipuram, Redhills Road, Ambattur, Chennai</p>
                    </div>
                    ...
                    <div className="flex items-center justify-center lg:justify-start">
                      ...
                      <p className="text-xs sm:text-sm md:text-base">+91 95144 17318</p>
                    </div>
